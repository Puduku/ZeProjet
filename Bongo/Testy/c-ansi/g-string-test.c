...
static int GStringTest (const char *p_vers3) {
  ...
  m_ASSERT(h_gString->nh_string != NULL)
  m_ASSERT(strcmp(h_gString->nh_string,VERS1) == 0)
  ...
  m_ASSERT(strcmp(h_gString->nh_string,p_vers3) == 0)
...
static int GParamTest (const char *p_vers3) {
  ...
  m_TRACK_IF(GStringPrintf(h_gParam + G_PARAM_VALUE_ELEMENT,  0,VERS3_FORMAT_S_S,
    VERS3_S1,VERS3_S2) < 0)
  m_ASSERT(strcmp(h_gParam[0].nh_string,"VERS3") == 0)
  m_ASSERT(strcmp(h_gParam[1].nh_string,p_vers3) == 0)
...
#define LOWER_FOOTER "aaaaaaaa"
  ...
  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING__G_KEYS_COMPARISON,  NULL, NULL,
    (STRING_PORTION_VALUE_FUNCTION)UNDEFINED, (void*)UNDEFINED) == 0)

  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING__G_KEYS_COMPARISON,  NULL, toupper,
  ...
  m_ASSERT(strcmp(gStringStuff->nh_string,LOWER_FOOTER) == 0)
  ...
  m_ASSERT(strcmp(gStringStuff->nh_string,VERS1) == 0)

  m_ASSERT(GStringsFetch(h_gStrings,  1,  &gStringStuff) == 1)
  m_ASSERT(strcmp(gStringStuff->nh_string,VERS2) == 0)
  ...
  m_ASSERT(strcmp(gStringStuff->nh_string,p_vers3) == 0)
