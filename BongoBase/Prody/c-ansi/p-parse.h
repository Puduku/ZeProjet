...
// 2. m_PARSE_PASS_*() macros: pass specific characters
...
// 3. m_PARSE_MATCH*() macros: pass matching tokens 
...
// 4. m_PARSE_TILL_*MATCH*() macros: scan till matching tokens 
...
// 5. m_PARSE_*() macros: miscellaneous parsing 
