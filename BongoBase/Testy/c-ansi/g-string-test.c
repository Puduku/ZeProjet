...
#define LOWER_FOOTER "aaaaaaaa"
  ...
  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING_PORTION__G_KEYS_COMPARISON,  NULL, NULL,
    (STRING_PORTION_INTRINSIC_VALUE_FUNCTION)UNDEFINED, (void*)UNDEFINED) == 0)

  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING_PORTION__G_KEYS_COMPARISON,  NULL, toupper,
    (STRING_PORTION_INTRINSIC_VALUE_FUNCTION)UNDEFINED, (void*)UNDEFINED) == 1)
  ...
  m_TRACK_IF(m_GStringsIndexSingleFetch(h_gStrings, (INDEX_REQUEST_AUTOMATIC_BUFFER)NULL,
    INDEX_LABEL0, INDEX_SEEK_FLAGS__ANY, (const struct G_KEY*)UNDEFINED,
  ...
  m_TRACK_IF(m_GStringsIndexSingleFetch(h_gStrings, (INDEX_REQUEST_AUTOMATIC_BUFFER)NULL,
    INDEX_LABEL1, INDEX_SEEK_FLAGS__ANY, (const struct G_KEY*)UNDEFINED,
    INDEX_FETCH_FLAGS__READ_ONLY, &gStringStuff, NULL) != RESULT__FOUND)
  m_ASSERT(strcmp(gStringStuff->nhi_string,LOWER_FOOTER) == 0)
