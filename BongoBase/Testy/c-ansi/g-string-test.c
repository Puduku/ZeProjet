...
#define     CASE__INDEX_LABEL 1
  ...
  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING_PORTION__G_KEYS_COMPARISON,  NULL, NULL,
    (STRING_PORTION_INTRINSIC_VALUE_FUNCTION)UNDEFINED, (void*)UNDEFINED) == NON_CASE__INDEX_LABEL)

  m_ASSERT(G_STRINGS_ADD_INDEX(h_gStrings,STRING_PORTION__G_KEYS_COMPARISON,  NULL, toupper,
    (STRING_PORTION_INTRINSIC_VALUE_FUNCTION)UNDEFINED, (void*)UNDEFINED) == CASE__INDEX_LABEL)
